...
public class QuizActivity extends AppCompatActivity
{
    ...
    private void checkAnswer(String paramString) {
        ...
        stringBuilder.append(this.mCurrentIndex);
        stringBuilder.append(".");
        Log.i("QuizActivity", stringBuilder.toString());
        ...
        this.mScoreView.setText(Integer.toString(this.score));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Collections.shuffle(Collections.singletonList(this.l));
        ...
        this.mDisneyButton.setOnClickListener(new View.OnClickListener() {
        ...
        this.mNickButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View param1View) {
                answer = "Nickelodeon";
                QuizActivity quizActivity = QuizActivity.this;
                quizActivity.checkAnswer(quizActivity.answer);
        ...
        this.mCartoonButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View param1View) {
        ...
        this.mFreeformButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View param1View) {
                answer = "Freeform";
                QuizActivity quizActivity = QuizActivity.this;
                quizActivity.checkAnswer(quizActivity.answer);
